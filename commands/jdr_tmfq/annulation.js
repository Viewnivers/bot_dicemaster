...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('annuler')
    .setDescription('Admin: Annulation de la programmation de la séances (TMFQ)')
  ...
  async execute(interaction) {
    ...
    const exampleEmbed = {
      title: '',
      description: '**The Medicine For Quest :**\n\n> En raison d\'une indisponibilité d\'un de nos joueure, nous annulons la séance prévus initialement pour la suite du Jeux De Rôle nommé | The Medicine For Quest\n\n*voir la date en cliquant sur le bouton*',
      image: {
